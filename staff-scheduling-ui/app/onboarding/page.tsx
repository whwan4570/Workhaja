    ...
    <div className="flex min-h-screen items-center justify-center bg-muted/30 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl font-bold">New Company Registration</CardTitle>
          <CardDescription>Get started with a 14-day free trial. Max 50 users, unlimited branches.</CardDescription>
        </CardHeader>
        <CardContent>
